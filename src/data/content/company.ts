// Company profile, service catalogue and contact routes — CLIENT-OWNED content
// (broker `content` lane, self-publishing). Edit names, descriptions, deliverables,
// principles, or contact-route copy freely; it self-publishes on green CI. The TYPES
// (Service shape) live in the structural shim `../company.ts`, which re-exports these
// values so existing `import { company } from "../data/company"` call sites are unchanged.
import type { Service } from "../company";

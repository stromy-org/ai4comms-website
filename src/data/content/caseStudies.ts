// Case-study / use-case library — CLIENT-OWNED content (broker `content` lane,
// self-publishing). Edit titles, summaries, sections, outcomes, and tags freely; it
// self-publishes on green CI. The CaseStudy TYPE lives in the structural shim
// `../caseStudies.ts`, which re-exports this array so existing call sites are unchanged.
